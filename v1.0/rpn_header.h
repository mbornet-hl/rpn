 ...
 *   rpn_header.h
 *
 *   @(#)  [MB] cy_rpn_header.h Version 1.59 du 19/06/05 - 
 */
...
#define   M                        fprintf(stdout, "%s (%d) CURRENT : %10lld TOTAL : %10lld PEAK : %10lld NB ALLOC : %10lld NB FREE : %10lld\n",\
                                           ...
                                           G.allocated_nb,       \
                                           G.free_nb);           \
//                                   fprintf(stdout, "%s sizeof(allocated_total) = %d\n",   \
//                                        __func__, sizeof(G.allocated_total));
...
#define   RPN_IPERF_TRACE_LEX(...)      { if (G.iperf.debug_level & RPN_DBG_LEX)  printf("IPERF_LEX  : " __VA_ARGS__); }
#define   RPN_IPERF_TRACE_YACC(...)     { if (G.iperf.debug_level & RPN_DBG_YACC) printf("IPERF_YACC : " __VA_ARGS__); }
...
#define   RPN_TYPE_DOUBLE               (4)
#define   RPN_TYPE_STRING               (5)
#define   RPN_TYPE_VECTOR_3             (6)
#define   RPN_TYPE_MATRIX               (7)
#define   RPN_TYPE_LITTERAL             (8)
#define   RPN_TYPE_START_MARKER         (9)
#define   RPN_TYPE_NEURAL_MLP          (10)
#define   RPN_TYPE_FILENAME            (11)
#define   RPN_TYPE_TRAINING_ELT        (12)
#define   RPN_TYPE_TRAINING_SET        (13)
#define   RPN_TYPE_TEST_ELT            (14)
#define   RPN_TYPE_TEST_SET            (15)
#define   RPN_TYPE_TEXT_FILE           (16)
#define   RPN_TYPE_LIST                (17)
#define   RPN_TYPE_TUPLE               (18)
#define   RPN_TYPE_OPAIR               (19)
...
#define   RPN_OP_NAME_GET_QUEUE         "get_queue"
...
#define   RPN_OP_ID_GET_QUEUE           (RPN_OP_BASE_LISTS + 5)
...
// Neural Networks
#define   RPN_OP_BASE_NEURAL            (RPN_OP_END_STATS + 1)
...
// System
#define   RPN_OP_BASE_SYSTEM            (RPN_OP_END_COMPUTER + 1)
#define   RPN_OP_END_SYSTEM              RPN_OP_ID_IPERF

#define   RPN_OP_ID_MEMORY              (RPN_OP_BASE_SYSTEM + 0)
#define   RPN_OP_ID_PAUSE               (RPN_OP_BASE_SYSTEM + 1)
#define   RPN_OP_ID_PING                (RPN_OP_BASE_SYSTEM + 2)
#define   RPN_OP_ID_IPERF               (RPN_OP_BASE_SYSTEM + 3)

// Types
#define   RPN_OP_BASE_TYPES             (RPN_OP_END_SYSTEM + 1)
...
{                                                                           \
     struct rpn_##name              *_##name;                               \
                                                                            \
     if ((_##name = (struct rpn_##name *) malloc(sizeof(*_##name))) == 0) { \
          rpn_err_msg_no_mem();                                             \
...
struct global_struct {
     ...
     int                                 sw_on;
     int                                 debug_level;
     int                                 test_result;       // XXX : Maybe move in stack struct ???
